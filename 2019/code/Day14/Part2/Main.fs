...
printfn "%i" (tcaer("FUEL", 1L, getProductDic(list1), true))
printfn "%i" (tcaer("FUEL", 82892753L, getProductDic(list3), true))
printfn "%i" (tcaer("FUEL",  5586022L, getProductDic(list4), true))
printfn "%i" (tcaer("FUEL",   460664L, getProductDic(list5), true))

let challengeInput = "QUERTYUIOP" // paste input string over dummy value
...
printfn "%i gives %i" maxUnder (tcaer("FUEL", maxUnder, getProductDic(challengeInput), true))
printfn "%i gives %i" minOver (tcaer("FUEL", minOver, getProductDic(challengeInput), true))
