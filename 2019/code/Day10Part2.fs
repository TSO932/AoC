...
module Day10Part2 =
    ...
    let vaporise(spaceMap:seq<string>,stationLocation) =
        //original version converting a single string with line breaks to a sequence of strings:
        ...
        zapAsteroids(((double 4.0, 0), seqOfAngles), 0)